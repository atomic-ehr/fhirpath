...
import { TypeAnalyzer, analyzeFHIRPath } from '../legacy-src/analyzer/analyzer';
import { ModelProvider } from '../legacy-src/analyzer/model-provider';
import { StaticSchemaRegistry } from '../legacy-src/analyzer/schemas';
import { AnalysisMode, type TypeRef } from '../legacy-src/analyzer/types';
import { testSchemas } from './test-schemas';

// Import registry to trigger operation registration
import '../legacy-src/registry';
