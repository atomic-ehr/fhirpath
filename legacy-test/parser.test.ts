...
import type { ASTNode, BinaryNode, LiteralNode, IdentifierNode, FunctionNode, UnionNode, IndexNode, CollectionNode, TypeCastNode, MembershipTestNode } from '../legacy-src/parser/ast';
