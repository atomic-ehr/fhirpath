...
import { FHIRPathParser } from '../../legacy-src/parser/parser';
import { parse, parseForEvaluation } from '../../legacy-src/api';
import type { ParseResult } from '../../legacy-src/parser/types';
