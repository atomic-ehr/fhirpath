...
import { Interpreter } from "../legacy-src/interpreter/interpreter";
import { Compiler } from "../legacy-src/compiler";
import { ContextManager } from "../legacy-src/interpreter/context";
import { parse } from "../legacy-src/parser";
import type { Context } from "../legacy-src/interpreter/types";
